...
const interpretations: Record<number, string> = {
  ...
  22: "الرقم الرئيسي - تحالف روحي استثنائي. هذا هو أعلى مستويات التوافق. كلا الشريكين مرتبطان على مستوى روحي عميق جداً. هذه العلاقة نادرة ومميزة، تجمع بين الحكمة والبناء العظيم. أنتما معاً قادران على تحقيق أشياء استثنائية. الحب هنا يتجاوز الماديات إلى معاني أعمق وأسمى."
}
...
const healingGuides: Record<number, string> = {
  ...
  22: "احتفلي بهذا التوافق الاستثنائي. أنتما تشاركان رابطة روحية نادرة. ركزي على بناء إرث مشترك وتحقيق أحلامكما معاً. هذه العلاقة قادرة على تغيير العالم من حولكما."
}
